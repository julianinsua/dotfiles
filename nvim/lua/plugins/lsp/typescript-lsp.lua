...
local create_lsp_bindings = function(bufnr)
	...
	vim.keymap.set('n', '<leader>rf', '<cmd>TSToolsRenameFile<cr>', bufopts('[r]e[n]ame'))
...
-- TYPESCRIPT.NVIM CONFIG |--> This package has been archived need to switch to something else
